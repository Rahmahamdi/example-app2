...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <nav class="nav_btns">
            <ul class="nav_links">
                <li><a class="active-link" href="{{ url('/connected')}}"><img src="{{asset('asset/connexion.png')}}" class="logo2" alt="">Connexion</a></li>
            </ul>
        </nav>
        </header>
        <main>
        ...
        <footer>
            <p>© Rahma Hamdi - All Rights Reserved for Educational Pruposes Only</p>
            </footer>
    </body>
</html>
